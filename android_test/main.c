...
static void test_thumb(void)
{
    ...
    uint32_t len = 0;
    unsigned char* code = read_file("/Volumes/extData/vm/unicorn_test/test/unicorn/unicorn/aef52000_36e000.so", &len);
    ...
    err = uc_emu_start(uc, BASE + ADDRESS + 1, BASE + 0x24a692, 0, 0);
    if (err) {
